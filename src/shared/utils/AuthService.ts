...
import { AuthEnum } from "shared/constants";
import { LoginResponse, Nullable } from "shared/types/types";
...
export default class AuthService {
  ...
  public static getTokenAuthHead() {
    return AxiosService.instance.defaults.headers.Authorization;
  }
}
